...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/cuanto-cuesta-carnet-conducir`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${SITE_URL}/cuanto-tarda-sacarse-carnet`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${SITE_URL}/requisitos-carnet-conducir`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
